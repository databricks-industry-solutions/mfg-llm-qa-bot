...
# MAGIC
# MAGIC In this notebook, we assemble the custom MLflow pyfunc wrapper and stage it in the MLFlow Model registry. We persist the model and make the required MLflow API call to register this model in the model registry. We change the stage of the model to Production.
# MAGIC
# MAGIC This continues from notebook 03.1
# MAGIC
# MAGIC <p>
...
# MAGIC * DBR 13.3ML
# MAGIC * i3.xlarge (AWS) - No GPUs needed.
...
# MAGIC %run ./03.1_Create_ML_FoundationalModel
